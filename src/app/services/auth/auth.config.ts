...
export interface IOauth1Options {
  ...
  oauthType?: string;
  exchangeForToken?: boolean | ((options: { code?: string, state?: string }, userData?: any) => Observable<any>);
  method?: string;
}
...
/// The config values in this service can be overrided by derived class of CustomConfig, 
/// AuthConfig in app.module.ts
@Injectable()
export class ConfigService {
  ...
  loginUrl = '/auth/login';
  signUrl = '/signup';
  updateRegistrationUrl = '/update_registration';
  unlinkUrl = '/auth/unlink/';
  refreshUrl = '/auth/refresh';
  forgotUrl = '/auth/forgot';
  tokenName = 'token';
  sendOTP='/validate/SendOTP';
  verifyOTP='/validate/VerifyOTP';
  tokenSeparator = '_';
  tokenPrefix = 'auth';
